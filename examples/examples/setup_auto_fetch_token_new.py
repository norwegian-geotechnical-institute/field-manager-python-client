...
KEYCLOAK_SERVER_URL = os.getenv("KEYCLOAK_SERVER_URL", "https://keycloak.test.ngiapi.no/auth/")
...
def authenticate():
    ...
    client = AuthenticatedClient(base_url=BASE_URL, token=token_manager.get_valid_token())
