        ...
        for response_200_item_data in _response_200:
            ...
            def _parse_response_200_item(
                ...
                try:
                    if not isinstance(data, dict):
                        raise TypeError()
                    response_200_item_type_8 = MethodSRSData.from_dict(data)
                ...
                try:
                    if not isinstance(data, dict):
                        raise TypeError()
                    response_200_item_type_9 = MethodSVTData.from_dict(data)
                ...
                try:
                    if not isinstance(data, dict):
                        raise TypeError()
                    response_200_item_type_10 = MethodTOTData.from_dict(data)
                ...
                try:
                    if not isinstance(data, dict):
                        raise TypeError()
                    response_200_item_type_11 = MethodTRData.from_dict(data)
                ...
                if not isinstance(data, dict):
                    raise TypeError()
                response_200_item_type_12 = MethodWSTData.from_dict(data)
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[HTTPValidationError | list[MethodCPTData | MethodDPData | MethodDTData | MethodPZData | MethodRCDData | MethodRPData | MethodSLBData | MethodSRSData | MethodSSData | MethodSVTData | MethodTOTData | MethodTRData | MethodWSTData]]
    """
...
def sync(
    ...
    *,
    ...
    Returns:
        HTTPValidationError | list[MethodCPTData | MethodDPData | MethodDTData | MethodPZData | MethodRCDData | MethodRPData | MethodSLBData | MethodSRSData | MethodSSData | MethodSVTData | MethodTOTData | MethodTRData | MethodWSTData]
    """
