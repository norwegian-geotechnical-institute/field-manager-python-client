...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/projects/{project_id}/organization-layer-groups".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Get Project Organization Layer Groups

     Get organization layer group templates available to a project.
