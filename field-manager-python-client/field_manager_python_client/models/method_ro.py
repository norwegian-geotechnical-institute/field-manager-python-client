...
class MethodRO:
    ...
    Attributes:
        ...
        method_type_id (Union[Literal[18], Unset]):  Default: 18.
    ...
    method_type_id: Union[Literal[18], Unset] = 18
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        method_type_id = cast(Union[Literal[18], Unset], d.pop("method_type_id", UNSET))
