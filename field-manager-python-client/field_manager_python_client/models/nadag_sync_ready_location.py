...
T = TypeVar("T", bound="NadagSyncReadyLocation")


@_attrs_define
class NadagSyncReadyLocation:
    """
    Attributes:
        location_id (UUID):
        name (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        nadag_sync_ready_location.additional_properties = d
        return nadag_sync_ready_location
