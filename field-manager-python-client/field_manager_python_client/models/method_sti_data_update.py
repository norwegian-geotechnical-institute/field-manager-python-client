...
T = TypeVar("T", bound="MethodSTIDataUpdate")


@_attrs_define
class MethodSTIDataUpdate:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        method_sti_data_update = cls(
            method_type_id=method_type_id,
            remarks=remarks,
            comment_code=comment_code,
        )

        method_sti_data_update.additional_properties = d
        return method_sti_data_update
