...
class OrganizationCreate:
    ...
    Attributes:
        ...
        can_approve_method (list[RoleEnum] | Unset):
        can_revoke_method_approval (list[RoleEnum] | Unset):
    """
    ...
    can_approve_method: list[RoleEnum] | Unset = UNSET
    can_revoke_method_approval: list[RoleEnum] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _can_approve_method is not UNSET:
            ...
            for can_approve_method_item_data in _can_approve_method:
                can_approve_method_item = RoleEnum(can_approve_method_item_data)
        ...
        if _can_revoke_method_approval is not UNSET:
            ...
            for can_revoke_method_approval_item_data in _can_revoke_method_approval:
                can_revoke_method_approval_item = RoleEnum(can_revoke_method_approval_item_data)
