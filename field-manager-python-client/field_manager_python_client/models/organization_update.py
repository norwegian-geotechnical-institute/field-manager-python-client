...
class OrganizationUpdate:
    ...
    Attributes:
        ...
        can_approve_method (list[RoleEnum] | None | Unset):
        can_revoke_method_approval (list[RoleEnum] | None | Unset):
    """
    ...
    can_approve_method: list[RoleEnum] | None | Unset = UNSET
    can_revoke_method_approval: list[RoleEnum] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_can_approve_method(data: object) -> list[RoleEnum] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for can_approve_method_type_0_item_data in _can_approve_method_type_0:
                    can_approve_method_type_0_item = RoleEnum(can_approve_method_type_0_item_data)
                ...
                pass
            return cast(list[RoleEnum] | None | Unset, data)

        can_approve_method = _parse_can_approve_method(d.pop("can_approve_method", UNSET))

        def _parse_can_revoke_method_approval(data: object) -> list[RoleEnum] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for can_revoke_method_approval_type_0_item_data in _can_revoke_method_approval_type_0:
                    can_revoke_method_approval_type_0_item = RoleEnum(can_revoke_method_approval_type_0_item_data)
