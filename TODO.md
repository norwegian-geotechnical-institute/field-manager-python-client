...
- [x] Clean debug setup package_version_override at config.yaml, Jiyang

## Documentation

- [x] Update the pypi documentation
...
- [x] Fix the uuid been regenerated every time in the following files
